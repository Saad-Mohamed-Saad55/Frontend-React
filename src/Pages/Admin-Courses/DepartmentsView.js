...
const DepartmentsView = ({ language }) => {
    ...
    const addDepartment = (name) => {
        if (name && !departments.some(dep => dep.department_name === name)) {
            ...
            axios.post('https://premiumbackend-i6je84wv.b4a.run//api/departments', { department_name: name })
                .then(res => {
                    if (res.data.success) {
    ...
    const updateDepartment = (id, name) => {
        axios.put(`https://premiumbackend-i6je84wv.b4a.run//api/departments/${id}`, { department_name: name })
            .then(res => {
                if (res.data.success) {
    ...
    const deleteDepartment = (id) => {
        axios.delete(`https://premiumbackend-i6je84wv.b4a.run//api/departments/${id}`)
            .then(res => {
                if (res.data.success) {
