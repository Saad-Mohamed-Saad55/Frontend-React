...
const DepartmentsCoursesView = ({ language, departments }) => {
    ...
    const fetchDepartmentsCourses = async () => {
        try {
            const response = await axios.get('https://premiumbackend-i6je84wv.b4a.run//api/departments-courses');
    ...
    useEffect(() => {
        axios.get('https://premiumbackend-i6je84wv.b4a.run//api/courses').then(response => {
    ...
    const handleAdd = async () => {
        try {
            await axios.post('https://premiumbackend-i6je84wv.b4a.run//api/departments-courses', {
    ...
    const handleSaveUpdate = async () => {
        try {
            await axios.put(`https://premiumbackend-i6je84wv.b4a.run//api/departments-courses/${editingCourse}`, {
    ...
    const handleDelete = (id) => {
        axios.delete(`https://premiumbackend-i6je84wv.b4a.run//api/departments-courses/${id}`)
            .then(res => {
                if (res.data.success) {
                    fetchDepartmentsCourses();
                }
