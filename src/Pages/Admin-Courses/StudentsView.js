...
const InstructorsView = ({ language }) => {
    ...
    useEffect(() => {
        ...
        axios.get('https://premiumbackend-i6je84wv.b4a.run//api/instructors-departments-courses')
            .then(response => {
        ...
        axios.get('https://premiumbackend-i6je84wv.b4a.run//api/students')
            .then(response => {
    ...
    const handleAdd = async () => {
        try {
            const response = await axios.post('https://premiumbackend-i6je84wv.b4a.run//api/students-enrollments', {
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://premiumbackend-i6je84wv.b4a.run//api/students-enrollments/${id}`);
            fetchInstructorsCourses();
