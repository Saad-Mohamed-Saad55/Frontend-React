...
const CoursesView = ({ language }) => {
    ...
    const fetchCourses = async () => {
        try {
            const response = await axios.get('https://premiumbackend-i6je84wv.b4a.run//api/courses');
    ...
    const addCourse = async (course) => {
        ...
        try {
            await axios.post('https://premiumbackend-i6je84wv.b4a.run//api/courses', formData, {
                headers: {
    ...
    const updateCourse = async (course) => {
        ...
        try {
            await axios.put(`https://premiumbackend-i6je84wv.b4a.run//api/courses/${course.course_code}`, formData, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
            });
    ...
    const deleteCourse = async (id) => {
        try {
            await axios.delete(`https://premiumbackend-i6je84wv.b4a.run//api/courses/${id}`);
            fetchCourses();
        } catch (err) {
