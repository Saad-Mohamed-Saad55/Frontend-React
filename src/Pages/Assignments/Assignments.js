...
const Assignments = ({ isDarkMode, language, userRole, userId }) => {
  ...
  useEffect(() => {
    axios.get(`https://premiumbackend-i6je84wv.b4a.run//api/student/${userId}/courses`)
  ...
  useEffect(() => {
    if (selectedCourse) {
      ...
      axios.get(`https://premiumbackend-i6je84wv.b4a.run//assignments/${selectedCourse}`)
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://premiumbackend-i6je84wv.b4a.run//upload-student-assignment', formData)
        .then(response => {
